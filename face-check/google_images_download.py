...
def dir_check():
    dir_name = os.listdir("./Original/")
    return dir_name

if __name__ == "__main__":
    main()
    # 名前変更と顔の切り出し作業まで一気にやる
    import background_files.until_cuttedFace.file_rename
    import background_files.until_cuttedFace.face_cut
